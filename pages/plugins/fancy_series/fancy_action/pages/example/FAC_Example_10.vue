...
- Action[a=Particle-Remove] ~onJoin</code>
  ...
  <a @click="fancyCoreSidebar.setPage('FC_Example_10')" href="/plugins/fancy_series/fancy_core/FancyCoreIndex" target="_blank" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
    <span class="ml-3">CoreAction10</span>
  </a>
</template>
